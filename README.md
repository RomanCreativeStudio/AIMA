...
├── ai-engine/    # AI provider abstraction, memory, context assembly, retrieval
...
Foundation Sprint in progress. UI clients (`apps/`) are not yet scaffolded — see `docs/TECHNICAL_ARCHITECTURE.md` §10 for the sprint plan.
