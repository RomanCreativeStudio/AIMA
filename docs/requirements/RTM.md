...
| `REQ-001` Authentication | `ARCH-001` §"Authentication", §9 | `ADR-0022` | `database/migrations/0020_auth_sessions.sql` | Not yet implemented — foundation only, not wired into `app.ts`/any route (placeholders in `REQ-001-PLAN`) | `backend/src/auth/` (`types.ts`, `errors.ts`, `jwt.ts`, `mockAuthProvider.ts`, `supabaseAuthProvider.ts`, `registry.ts`, `sessionService.ts`), `backend/src/middleware/auth.ts`, `backend/src/middleware/workspaceOwnership.ts` | `backend/src/auth/jwt.test.ts`, `mockAuthProvider.test.ts`, `supabaseAuthProvider.test.ts`, `sessionService.test.ts`, `backend/src/middleware/auth.test.ts`, `workspaceOwnership.test.ts` | [`REQ-001-authentication.md`](REQ-001-authentication.md), [`REQ-001-implementation-plan.md`](REQ-001-implementation-plan.md), [`ADR-0022`](../decisions/0022-authentication-architecture.md), [`ECIA-001`](../governance/ECIA-001-authentication-foundation.md), [`RISK-001`](../governance/RISK-001-unauthenticated-endpoints.md) |
