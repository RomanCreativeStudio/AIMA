...
| `REQ-001` Authentication | `ARCH-001` §"Authentication", §9 | None registered yet | Not yet implemented | Not yet implemented | Not yet implemented | Not yet implemented | [`REQ-001-authentication.md`](REQ-001-authentication.md) |
