...
| Technical Debt Register | `TD-*` | [`docs/governance/`](governance/) | Framework active (`TD-INDEX`/`TD-TEMPLATE`); 1 debt item registered (`TD-001`). |
| Technical Debt Register Index | `TD-INDEX` | [`docs/governance/TD-INDEX.md`](governance/TD-INDEX.md) | Active. Canonical index of every technical debt entry's status, priority, and file; 1 entry (`TD-001`). |
