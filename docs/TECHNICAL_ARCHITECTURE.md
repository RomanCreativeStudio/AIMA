...
- Replace the Phase 2.3 stub connectors with real Gmail/GitHub/Calendar API clients, and wire a route that actually reads data through one — gated by the four capabilities Phase 2.3 already registered.
