...
- Replace the Phase 2.3/2.6 stub connectors with real Gmail/GitHub/Calendar API clients — the `ActionExecutor`/`IntegrationConnector` framework built in Phase 2.6 is what a real client slots into; only the network calls themselves remain stubbed.
